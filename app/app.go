...
import (
	...
	bookmodule "book/x/book"
	bookmodulekeeper "book/x/book/keeper"
	bookmoduletypes "book/x/book/types"
...
type App struct {
	*baseapp.BaseApp
	...
	BookKeeper bookmodulekeeper.Keeper
...
func New(
	...
	app.BookKeeper = *bookmodulekeeper.NewKeeper(
		appCodec,
		keys[bookmoduletypes.StoreKey],
		keys[bookmoduletypes.MemStoreKey],
		app.GetSubspace(bookmoduletypes.ModuleName),
	)
	bookModule := bookmodule.NewAppModule(appCodec, app.BookKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(bookmoduletypes.ModuleName)
